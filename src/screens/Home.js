...
function onSelectCatogory(category){
// filter restaurant
...
<View style={{flexDirection:'row', marginLeft:10}}>{
    ...
    item.categories.map((cagoryId) => {
        return (
            <View style={{flexDirection:'row', }} key={cagoryId}>
               <Text style={{...FONTS.body3}}>{getCategoryNameById(cagoryId)}</Text>
